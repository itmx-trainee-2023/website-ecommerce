...
import productdetail1 from "../../../public/img/product/productdetail1.png";
import productdetail2 from "../../../public/img/product/productdetail2.png";
import productdetail3 from "../../../public/img/product/productdetail3.png";
import black from "../../../public/img/product/black.png";
import pink from "../../../public/img/product/pink.png";
import red from "../../../public/img/product/red.png";
import white from "../../../public/img/product/white.png";
import review1 from "../../../public/img/product/review1.png";
import review2 from "../../../public/img/product/review2.png";
    ...
    <div className="mx-auto max-w-screen-xl">
      ...
      <div className="flex flex-col md:flex-row ">
        <div className="w-full md:w-1/2 lg:px-0 px-16">
          <div className="carousel lg:w-full w-80 flex ">
            ...
            <div id="slide2" className="carousel-item relative w-full">
              <Image src={productdetail1} alt={""} width={600}/>
              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide3" className="carousel-item relative w-full">
              <Image src={productdetail2} alt={""} width={600}/>
              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide4" className="carousel-item relative w-full">
              <Image src={productdetail3} alt={""} width={600}/>
              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
        ...
        <div className="w-full md:w-1/2 lg:px-0 px-16 lg:mt-0 mt-5">
          ...
          <div>
            <div>
              <h2 className="lg:text-3xl text-3xl  font-bold mt-5 mb-5">Tray Table</h2>
            </div>
            ...
            <div className="mt-5">
              <h1 className="text-2xl font-bold mb-5">$199.00</h1>
            </div>
            <hr></hr>
            <div>
            ...
            <div className="flex mt-5">
              <p>SKU</p>
              <p className="ml-32">1117</p>
            </div>
            <div className="flex mt-5">
              <p>GATEGORY</p>
              <p className="ml-20 mb-10">Living Room, Bedroom</p>
            </div>
            <div>
      ...
      <div>
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-20">
            <Image src={review1} alt={""} width={50} />
          </div>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-20 mt-5">
            <Image src={review2} alt={""} width={50} />
          </div>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-20 mt-5">
            <Image src={review3} alt={""} width={50} />
          </div>
          <div className="w-full md:w-50 ml-0 mt-5">
            <div>
              <p>Nicolas Jensen</p>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-20 mt-5">
            <Image src={review4} alt={""} width={50} />
          </div>
          <div className="w-full md:w-50 ml-0 mt-5">
            <div>
              <p>Nicolas Jensen</p>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-20 mt-5">
            <Image src={review5} alt={""} width={50} />
          </div>
          <div className="w-full md:w-50 ml-0 mt-5">
            <div>
              <p>Nicolas Jensen</p>
