          ...
          <div className="grid justify-items-center">
            <div>
              <div>
                ...
                {/* <div >
                  <div className="grid grid-cols-3 gap-5 mx-auto max-w-7xl ">
                    <div className="pr-5 relative pt-5 pb-5 lg:max-w-none lg:grid-cols-3">
                      <div className="card flex max-w-xl flex-col items-start justify-between relative">
                        <div>
                      <Image
                          src={card1}
                          className="h-full w-full object-cover object-center lg:h-full lg:w-full overflow-hidden relative width: 250px"
                          alt=""
                        />
                        </div>
                        ...
                        <div className="card-body">
                          <button
                            className="flex-none flex items-center justify-center w-10 h-10 rounded-full text-white border border-slate-200 bg-white ml-44 mb-56 "
                            type="button"
                            aria-label="Like"
                          >
                            <svg
                    ...
                    <div className="pr-5 relative pt-5 pb-5">
                      <div className="card">
                        <Image
                          src={card2}
                          className="h-full w-full object-cover object-center lg:h-full lg:w-full overflow-hidden relative width: 250px"
                  ...
                  <div className="grid grid-cols-3 gap-5">
                    <div className="font-bold">Loveseat Sofa</div>
                    <div className="font-bold">Luxury Sofa</div>
                  ...
                  <div className="grid grid-cols-3 gap-5">
                    ...
                    <div className="font-bold">$19.00</div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-5">
                    <div className="font-bold">White Drawer unit</div>
                    <div className="font-bold">Black Tray table</div>
                    <div className="font-bold">Lamp</div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-5">
                    <div className="font-bold">Light Beige Pillow</div>
                    <div className="font-bold">Table Lamp</div>
                    <div className="font-bold">Bamboo Basket</div>
                  </div>
                  <div className="grid grid-cols-3 gap-5">
                    <div className="font-bold">$3.99</div>
